...
<head>
    ...
    <style>
        .btn_preview{
            background: url("img/btn_preview.jpg") no-repeat;
            border:none;
            padding:7px 18px;
            float:left;
            cursor:pointer;
        ...
        .btn_down{
            background:  url("img/btn_down.jpg");
            padding:5px 17px;
            border:none;
            float: right;
            margin-right: 10px;
        ...
        #btn_reply {
            background: url(img/zr_btn_reply.jpg) no-repeat;
            width: 79px;
            height: 34px;
            border: none;
            cursor: pointer;
    ...
    <div id="resrc_mayLike">
        ...
        <ul>
            <li class="resrc_mayLike">
                <div class="pic_mayLike"><img src="img/fileIcon/doc.png"/></div>
            ...
            <li class="resrc_mayLike">
                <div class="pic_mayLike"><img src="img/fileIcon/txt.png"/></div>
                <div class="detail_mayLike">
                    <a href="#" class="pic_title">> Java编程</a>
                    <div class="star_ratingCur">
                        <div>书评：</div>
...
<div class="doc_type">
    <ul>
        <a href="" ><li class="selected_type">电子资源</li></a>
        <a href="" ><li>图书资源</li></a>
    </ul>
    <div class="clr"></div>
</div>
<div id="article">
    <div id="bResrc">
        <div id="bPic"><img src="img/fileIcon/${resource.resourceType}.png"/></div>
        <div id="bMess">
            <p id="bTitle">${resouce.resourceRealName}</p>
            <p id="author">上传者：${resource.uploadUserName}</p>
            <p id="puber">文件类型：${resource.resourceType}</p>
            <p id="pubtime">文件大小：${resource.resourceSize/1000000}MB</p>
            <p id="kind">所属分类：计算机技术</p>
            <p id="pg">下载次数：${resource.downloadTimes}</p>
            <p id="caifu">所需财富值：2</p>
            <div class="star_ratingCur">
                <div>读者评价：</div>
                <ul><li><img src="img/rating_star.jpg"></li>
                    <li><img src="img/rating_star.jpg"></li>
            ...
            <div class="btn_cont">
                ...
                <input type="button" class="btn_preview" value="&nbsp;&nbsp;在线预览"/>
            </div>
        </div>
    </div>
    <div id="bResrcSimi">
