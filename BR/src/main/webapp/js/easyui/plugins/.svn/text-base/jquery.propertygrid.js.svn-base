...
$(_2).datagrid("getPanel").find("div.datagrid-community").css("border","0");
...
var _1a=_19[i];
_17.push("<div class=\"datagrid-community\" community-index="+i+" style=\"height:25px;overflow:hidden;border-bottom:1px solid #ccc;\">");
...
var _23=_21.find("div.datagrid-community");
}else{
var _23=_22.find("div.datagrid-community");
}
...
_20.find("div.datagrid-community").each(function(){
var _24=$(this).attr("community-index");
...
if(_2e!=undefined){
var _30=_2f.find("div.datagrid-community[community-index=\""+_2e+"\"]");
}else{
var _30=_2f.find("div.datagrid-community");
}
...
if(_32!=undefined){
var _34=_33.find("div.datagrid-community[community-index=\""+_32+"\"]");
}else{
var _34=_33.find("div.datagrid-community");
}
...
$.fn.propertygrid.defaults=$.extend({},$.fn.datagrid.defaults,{singleSelect:true,remoteSort:false,fitColumns:true,loadMsg:"",frozenColumns:[[{field:"f",width:16,resizable:false}]],columns:[[{field:"name",title:"Name",width:100,sortable:true},{field:"value",title:"Value",width:100,resizable:false}]],showGroup:false,groupField:"community",groupFormatter:function(_36,_37){
return _36;
}});
})(jQuery);
