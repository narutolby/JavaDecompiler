...
},plugins:["draggable","droppable","resizable","pagination","linkbutton","menu","menubutton","splitbutton","progressbar","tree","combobox","combotree","combogrid","numberbox","validatebox","searchbox","numberspinner","timespinner","calendar","datebox","datetimebox","slider","layout","panel","datagrid","propertygrid","treegrid","tabs","accordion","window","dialogs"],parse:function(_2){
var aa=[];
...
function _1f4(_1f5){
var t=$(_1f5);
t.wrapInner("<div class=\"dialogs-content\"></div>");
var _1f6=t.children("div.dialogs-content");
...
function _1f7(_1f8){
var opts=$.data(_1f8,"dialogs").options;
var _1f9=$.data(_1f8,"dialogs").contentPanel;
if(opts.toolbar){
if(typeof opts.toolbar=="string"){
$(opts.toolbar).addClass("dialogs-toolbar").prependTo(_1f8);
$(opts.toolbar).show();
}else{
$(_1f8).find("div.dialogs-toolbar").remove();
var _1fa=$("<div class=\"dialogs-toolbar\"></div>").prependTo(_1f8);
for(var i=0;i<opts.toolbar.length;i++){
var p=opts.toolbar[i];
if(p=="-"){
_1fa.append("<div class=\"dialogs-tool-separator\"></div>");
}else{
...
$(opts.buttons).addClass("dialogs-button").appendTo(_1f8);
$(opts.buttons).show();
}else{
$(_1f8).find("div.dialogs-button").remove();
var _1fb=$("<div class=\"dialogs-button\"></div>").appendTo(_1f8);
...
_1f9.panel("resize",{width:_201.width(),height:(_200=="auto")?"auto":_201.height()-_201.find(">div.dialogs-toolbar").outerHeight()-_201.find(">div.dialogs-button").outerHeight()});
if(opts.onResize){
...
var _204=$.data(_203,"dialogs").contentPanel;
_204.panel("refresh",href);
};
$.fn.dialogs=function(_205,_206){
if(typeof _205=="string"){
var _207=$.fn.dialogs.methods[_205];
if(_207){
...
_205=_205||{};
return this.each(function(){
var _208=$.data(this,"dialogs");
if(_208){
$.extend(_208.options,_205);
}else{
$.data(this,"dialogs",{options:$.extend({},$.fn.dialog.defaults,$.fn.dialog.parseOptions(this),_205),contentPanel:_1f4(this)});
}
_1f7(this);
});
};
$.fn.dialogs.methods={options:function(jq){
var _209=$.data(jq[0],"dialogs").options;
...
var _20b=$.data(jq[0],"dialogs").contentPanel;
return _209;
},dialogs:function(jq){
...
$.fn.dialogs.parseOptions=function(_20c){
return $.extend({},$.fn.window.parseOptions(_20c),$.parser.parseOptions(_20c,["toolbar","buttons"]));
};
$.fn.dialogs.defaults=$.extend({},$.fn.window.defaults,{title:"New Dialogs",collapsible:false,minimizable:false,maximizable:false,resizable:false,toolbar:null,buttons:null});
})(jQuery);
(function($){
...
_42e.children("div.datagrid-header,div.datagrid-body,div.datagrid-footers").width(_42e.width());
_42f.children("div.datagrid-header,div.datagrid-body,div.datagrid-footers").width(_42f.width());
var hh;
_430.css("height","");
_431.css("height","");
_432.css("height","");
...
if(opts.height!="auto"){
var _435=_42d-_42f.children("div.datagrid-header").outerHeight(true)-_42f.children("div.datagrid-footers").outerHeight(true)-wrap.children("div.datagrid-toolbar").outerHeight(true);
...
_43a(tr1,tr2);
if(opts.showFooter){
var tr1=opts.finder.getTr(_437,0,"allfooters",1);
var tr2=opts.finder.getTr(_437,0,"allfooters",2);
_43a(tr1,tr2);
}
}
}
...
var _446=$("<div class=\"datagrid-wrap\">"+"<div class=\"datagrid-view\">"+"<div class=\"datagrid-view1\">"+"<div class=\"datagrid-header\">"+"<div class=\"datagrid-header-inner\"></div>"+"</div>"+"<div class=\"datagrid-body\">"+"<div class=\"datagrid-body-inner\"></div>"+"</div>"+"<div class=\"datagrid-footers\">"+"<div class=\"datagrid-footers-inner\"></div>"+"</div>"+"</div>"+"<div class=\"datagrid-view2\">"+"<div class=\"datagrid-header\">"+"<div class=\"datagrid-header-inner\"></div>"+"</div>"+"<div class=\"datagrid-body\"></div>"+"<div class=\"datagrid-footers\">"+"<div class=\"datagrid-footers-inner\"></div>"+"</div>"+"</div>"+"</div>"+"</div>").insertAfter(_441);
...
return {panel:_446,frozenColumns:cc[0],columns:cc[1],dc:{view:view,view1:_449,view2:_44a,header1:_449.children("div.datagrid-header").children("div.datagrid-header-inner"),header2:_44a.children("div.datagrid-header").children("div.datagrid-header-inner"),body1:_449.children("div.datagrid-body").children("div.datagrid-body-inner"),body2:_44a.children("div.datagrid-body"),footers1:_449.children("div.datagrid-footers").children("div.datagrid-footers-inner"),footers2:_44a.children("div.datagrid-footers").children("div.datagrid-footers-inner")}};
};
function _44b(_44c){
...
dc.footers1.add(dc.footers2).css("display",opts.showFooter?"block":"none");
if(opts.toolbar){
if(typeof opts.toolbar=="string"){
...
dc.view2.children("div.datagrid-header,div.datagrid-footers").scrollLeft($(this).scrollLeft());
});
function _46a(tr){
...
var _484=Math.max(_483.outerWidth(),_485("allbody"),_485("allfooters"));
...
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,_4a0,dc.footers2,false);
opts.view.renderFooter.call(opts.view,_4a0,dc.footers1,true);
}
...
if(_580){
$.data(this,"datagrid").footers=_580;
}
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,this,dc.footers2,false);
opts.view.renderFooter.call(opts.view,this,dc.footers1,true);
if(opts.view.onAfterRender){
...
return $.data(jq[0],"datagrid").footers;
...
var rows=$.data(_5a7,"datagrid").footers||[];
...
if(opts.showFooter){
var _5c4=$(_5c3).datagrid("getPanel").find("div.datagrid-footers");
...
if(type=="footers"){
return (_5cc==1?dc.footers1:dc.footers2).find(">table>tbody>tr[datagrid-row-index="+_5cb+"]");
}else{
if(type=="selected"){
...
if(type=="allfooters"){
return (_5cc==1?dc.footers1:dc.footers2).find(">table>tbody>tr[datagrid-row-index]");
}
}
}
}
...
$(_5f1).datagrid("getPanel").find("div.datagrid-community").css("border","0");
...
var _603=_602[i];
_600.push("<div class=\"datagrid-community\" community-index="+i+" style=\"height:25px;overflow:hidden;border-bottom:1px solid #ccc;\">");
...
var _60a=_608.find("div.datagrid-community");
}else{
var _60a=_609.find("div.datagrid-community");
}
...
view.find("div.datagrid-community").each(function(){
var _60b=$(this).attr("community-index");
...
if(_613!=undefined){
var _614=view.find("div.datagrid-community[community-index=\""+_613+"\"]");
}else{
var _614=view.find("div.datagrid-community");
}
...
var view=$.data(this,"datagrid").dc.view;
if(_616!=undefined){
var _617=view.find("div.datagrid-community[community-index=\""+_616+"\"]");
}else{
var _617=view.find("div.datagrid-community");
}
...
$.fn.propertygrid.defaults=$.extend({},$.fn.datagrid.defaults,{singleSelect:true,remoteSort:false,fitColumns:true,loadMsg:"",frozenColumns:[[{field:"f",width:16,resizable:false}]],columns:[[{field:"name",title:"Name",width:100,sortable:true},{field:"value",title:"Value",width:100,resizable:false}]],showGroup:false,groupField:"community",groupFormatter:function(_619,rows){
return _619;
}});
})(jQuery);
(function($){
...
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,_64b,dc.footers1,true);
opts.view.renderFooter.call(opts.view,_64b,dc.footers2,false);
}
if(opts.view.onAfterRender){
...
var dc=$.data(this,"datagrid").dc;
if(_697){
$.data(this,"treegrid").footers=_697;
}
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,this,dc.footers1,true);
opts.view.renderFooter.call(opts.view,this,dc.footers2,false);
...
return $.data(jq[0],"treegrid").footers;
},getRoot:function(jq){
return _65a(jq[0]);
},getRoots:function(jq){
return _65c(jq[0]);
...
var rows=$.data(_6a9,"treegrid").footers||[];
...
if(data.footers){
$.data(_6bb,"treegrid").footers=data.footer;
}
if(data.total){
...
if(type=="footers"){
return (_6cc==1?dc.footers1:dc.footers2).find("tr[node-id="+id+"]");
}else{
if(type=="selected"){
...
if(type=="allfooters"){
return (_6cc==1?dc.footers1:dc.footesr2).find("tr[node-id]");
}
}
}
}
